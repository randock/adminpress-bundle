...
class ProfileMenuPass implements CompilerPassInterface
{
    public function process(ContainerBuilder $container)
    {
        $taggedServices = $container->findTaggedServiceIds('randock_admin_press.profile_menu_add_items');

        $definition = $container->getDefinition('randock_admin_press.menu.profile_menu_builder');
